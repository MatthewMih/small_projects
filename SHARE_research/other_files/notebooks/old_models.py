...
class Model2(nn.Sequential): #372k
    def __init__(self):
        super().__init__()
...
class Model3(nn.Sequential): #481k
    def __init__(self):
        super().__init__()
...
class Model4(nn.Sequential): #1.059M
    def __init__(self):
        super().__init__()
...
class Model5(nn.Sequential): #don't use it 102k
    def __init__(self):
        super().__init__()
        ...
        self.layers = nn.Sequential(
            ...
            nn.MaxPool2d(kernel_size=2),
            MBConv(in_c=64, out_c=128, inner_c=256), # 4x4
...
class Model5m(nn.Sequential): #100k
    def __init__(self):
        super().__init__()
...
class Model6(nn.Sequential): #51k
    def __init__(self):
        super().__init__()
...
class Model7(nn.Sequential): # 10,052 DON"T USE IT
    def __init__(self):
        super().__init__()
        
        self.layers = nn.Sequential(        
            MBConv(in_c=3, out_c=16, inner_c=24), # 32x32
            
            nn.MaxPool2d(kernel_size=2),
            MBConv(in_c=16, out_c=16, inner_c=32), # 16x16
            
            nn.MaxPool2d(kernel_size=2),
            MBConv(in_c=16, out_c=32, inner_c=16), # 8x8
            
            nn.MaxPool2d(kernel_size=2),
            MBConv(in_c=32, out_c=32, inner_c=32), # 4x4
...
class Model8(nn.Sequential): # 9,636 USE IT
    def __init__(self):
        super().__init__()
...
class Model9(nn.Sequential): # 4,956
    def __init__(self):
        super().__init__()
